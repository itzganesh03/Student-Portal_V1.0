                    ...
                    <div class="col-lg-12 col-xlg-12 col-md-12">
                        <div class="card">
                            ...
                            <ul class="nav nav-tabs profile-tab" role="tablist">
                                ...
                                <!--<li class="nav-item"> <a class="nav-link" data-toggle="tab" href="#Project" role="tab">Project task </a> </li>-->
                                ...
                                <br/>
                                    ...
                                    <div class="modal-footer">
                                       <input type="hidden" name="proid" value="<?php echo $details->id; ?>">
                                        ...
                                        <button type="submit" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?>  <?php } ?> class="btn btn-primary">Submit</button>
                                    </div>
                                    </form>
				                        </div>
                                    </div>                                           
