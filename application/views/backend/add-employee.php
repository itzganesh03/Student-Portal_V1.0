    ...
    <?php $depvalue = $this->employee_model->getdepartment(); ?>
            <div class="container-fluid">
                <div class="row m-b-10"> 
                    <div class="col-12">
                        <button type="button" class="btn btn-primary"><i class="fa fa-bars"></i><a href="<?php echo base_url(); ?>employee/Employees" class="text-white"><i class="" aria-hidden="true"></i>  Student List</a></button>
                    ...
                    <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white"><i class="fa fa-user-o" aria-hidden="true"></i> Add New Student & Staff<span class="pull-right " ></span></h4>
                            </div>
                            ...
                            <div class="card-body">
                                ...
                                <form class="row" method="post" action="Save" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group col-md-3 m-t-20">
                                        <label>Last Exam Gread</label>
                                        <input type="text" name="em_gread" class="form-control" placeholder="Gread"  > 
                                    </div>
                                    <div class="form-group col-md-3 m-t-20">
