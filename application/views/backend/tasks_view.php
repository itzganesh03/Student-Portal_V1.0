                                            ...
                                            <div class="form-group row">
                                              ...
                                              <div class="form-group row">
                                               <label class="control-label col-md-3">Status: </label>
                                                ...
                                                <input name="status" type="radio" id="radio_3" data-value="Logistic" class="type" value="Drop">
                                                <label for="radio_3">Drop</label>
                                                <input name="status" type="radio" id="radio_4" data-value="Logistic" class="type" value="Assigned">
                                                <label for="radio_4">Assigned</label>
                                            </div>                                             
                                              <div class="form-group row">
                                               <label class="control-label col-md-3">Type: </label>
                                                <input name="type" type="radio" id="radio_4" data-value="Logistic" class="type" value="Office">
                                                <label for="radio_4">Office</label>
                                                <input name="type" type="radio" id="radio_5" data-value="Logistic" class="type" value="Project">
                                                <label for="radio_5">Project</label>
