                                ...
                                <a class="btn btn-circle btn-secondary" href="<?php if(!empty($socialmedia->google_Plus)) echo $socialmedia->google_Plus ?>" target="_blank"><i class="fa fa-google"></i></a>
                                            ...
                                            <?php endforeach; ?>
                                                    ...
                                                    <div class="form-group col-md-4 m-t-10">
                                                        ...
                                                        <input type="text" <?php if($this->session->userdata('user_type')=='EMPLOYEE'){ ?> readonly <?php } ?> class="form-control"placeholder="Last Exam Gread" name="em_Gread" value="<?php echo $basic->em_Gread; ?>" minlength="4"> 
                                                    </div>
