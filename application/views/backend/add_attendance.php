                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <select class="form-control custom-select" data-placeholder="" tabindex="1" name="place" required>
                                                    <option value="Class" <?php if(isset($attval->place) && $attval->place == "Class") { echo "selected"; } ?>>Class</option>
                                                    <option value="Lab"  <?php if(isset($attval->place) && $attval->place == "Lab") { echo "selected"; } ?>>Lab</option>
                                                    <option value="Tutorial" <?php if(isset($attval->place) && $attval->place == "Tutorial") { echo "selected"; } ?>>Tutorial</option>
                                                    <option value="Extra" <?php if(isset($attval->place) && $attval->place == "Extra") { echo "selected"; } ?>>Extra</option>
                                                </select>
                                        </div> 
                                    </div>
