...
<head>
    ...
    <meta name="author" content="DYPIU-Akurdi">
    <!-- Favicon icon -->
    <?php $settingsvalue = $this->settings_model->GetSettingsValue(); ?>
    <link rel="icon" type="image/ico" sizes="16x16" href="<?php echo base_url(); ?>assets/images/download1.ico">
    <title>DYPIU-Dashboard</title>
    <!-- Bootstrap Core CSS -->
            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-light">
                <div class="navbar-header">
                    <a class="navbar-brand" href="<?php echo base_url(); ?>"><b>
                        ...
                        <!-- Logo text --><span>
                        <img src="<?php echo base_url(); ?>assets/images/<?php echo $settingsvalue->sitelogo; ?>" alt="homepage" class="dark-logo" height="50px" width="50px"/>
                         <!-- Light Logo text -->    
                         </span> </a>
                </div>
