                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                       ...
                       <!-- <li> <a href="<?php echo base_url(); ?>" ><i class="mdi mdi-gauge"></i><span class="hide-menu">Dashboard </span></a></li>-->
                        ...
                        <li> <a href="<?php echo base_url(); ?>employee/view?I=<?php echo base64_encode($basicinfo->em_id); ?>" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Students </span></a>
                        </li>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-briefcase-check"></i><span class="hide-menu">Projects </span></a>
                         ...
                         <li> 
                        <a href="http://dypiu-student-portal.epizy.com/exam-portal/"><i class="mdi mdi-account-box-outline"></i>Online-Exam Portal</a>
                        </li>
                        <!--<li> <a href="#"><i class="mdi mdi-clipboard-account"></i><span class="hide-menu">Certificate request</a></li> -->
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i class="mdi mdi-account-multiple"></i><span class="hide-menu">Students & Staff </span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="<?php echo base_url(); ?>employee/Employees">Students & Staff </a></li>
                        ...
                        <li> <a href="http://dypiu-student-portal.epizy.com/exam-portal/" ><i class="mdi mdi-account-box-outline"></i><span class="hide-menu">Online-Exam-Admin-side    <span class="hide-menu"></a></li>
